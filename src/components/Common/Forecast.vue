				...
				<div class="col-12 col-sm-8 col-md-9">
					...
					<table class="table table-striped">
						...
						<tr v-if="!isLoading" v-for="forecast in setForecast">
							...
							<td>
								<router-link :to="`/forecast/${forecast.identifier_id}`">{{ forecast.home }} - {{
									forecast.away }}
								</router-link>
							</td>
							<td>
								<router-link :to="`/forecast/${forecast.identifier_id}`" class="btn btn-sm btn-info">
									Yorum Yap
								</router-link>
							</td>
						</tr>
