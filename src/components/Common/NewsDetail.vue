                ...
                <div class="col-12 col-md-8 col-lg-9 news-detail" >
                    <div class="top clearfix">
                        ...
                        <div class="float-right clearfix">
                            <button style="height: 37px;" class="btn-facebook"><i class="fab fa-facebook-f"></i></button>
                            <button style="height: 37px;" class="btn-twitter"><i class="fab fa-twitter"></i></button>
                            <button style="height: 37px;" class="btn-google-plus"><i class="fab fa-google-plus-g"></i></button>
                            <button style="height: 37px;" class="btn-pinterest"><i class="fab fa-pinterest-p"></i></button>
                        </div>
                    </div>
                    <div class="news">
