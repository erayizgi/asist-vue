<template>
	<div>
		...
		<div class="container" id="user-list">
			<div class="row mb-15">
				<div class="col-12">
					<h1 class="title with-border">Takip Ettikleri</h1>
				</div>
			</div>
			<div class="row mb-15">
				<!-- single user -->
						...
						<div class="info float-right">
							<div class="clearfix user">
								...
								<div class="float-right">
									<follow :follower="user.kullaniciAdi" :t-class="'col-12 profile-buttons'"
									        :following="usr.data.kullaniciAdi"/>
								</div>
							</div>
...
<script>
	...
	export default {
		components: {ProfileHead, Follow, Spinner},
		name: "Following",
		data() {
			return {
				followers: [],
		...
		created() {
			this.isLoading = true;
			this.$store.dispatch("users/getFollowingUser", {
