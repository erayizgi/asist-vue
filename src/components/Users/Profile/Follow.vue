<template>
    <div :class="tClass">
        ...
        <a v-if="isFollowing && isUserProfile" class="btn-send-message" data-toggle="modal"
           data-target="#new_user_message">
            <i class="fa fa-envelope"></i>MESAJ GÖNDER
        </a>

        <div v-if="isUserProfile" class="modal fade" id="new_user_message" tabindex="-1" role="dialog"
