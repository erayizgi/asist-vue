					...
					<div class="col-12 col-sm-8 col-md-9 task-detail" v-if="isLogged">
						...
						<div class="row nomargin">
							...
							<div class="form-group col-12">
								...
								<input class="form-control" type="text" v-model="userData.adSoyad"
								       v-validate="'required'" name="Ad Soyad">
							...
							<div class="form-group col-12">
								...
								<input class="form-control" type="text" v-model="userData.kullaniciHakkinda"
								       v-validate="'required'" name="Hakkınızda">
								<small class="form-text text-muted">Diğer kullanıcıların profilinize göz attıklarında
									karşılarına
							...
							<div class="form-group col-12">
								...
								<input class="form-control" type="text" name="Doğum Tarihi"
								       v-model="userData.kullaniciDogumTarihi"
								       v-validate="'required|date_format:DD/MM/YYYY'">
								<span class="text-danger">{{errors.first("Doğum Tarihi")}}</span>
								<small class="form-text text-muted">Lütfen doğum tarihinizi gün/ay/yıl şeklinde
									giriniz.
								</small>
							</div>
							<div class="form-group col-12">
							...
							<div class="form-group col-12">
								...
								<input class="form-control" type="text" name="email" v-model="userData.kullaniciTelefon"
								       readonly>
								<small class="form-text text-muted">Cep numaranız herkes tarafından
							...
							<div class="form-group col-12">
								<div class="form-check">
									...
									<label class="form-check-label">Takip ettiğim tahminciler yeni kupon paylaştığı
										zaman SMS almak
										istiyorum.</label>
								</div>
							</div>
