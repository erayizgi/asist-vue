	...
	<div class="col-12 col-md-9">
		...
		<div v-if="posts.length === 0">
			<div class="alert alert-warning">
				<h6>
					<strong>Kupon Paylaşımı Yok!</strong> <br> Henüz Kullanıcı Kupon Paylaşımında Bulunmamış!
				</h6>
			</div>
		</div>
				...
				<div class="float-right">
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item facebook" href="#"><i class="fab fa-facebook"></i> Facebook'ta
								Paylaş</a>
							<a class="dropdown-item twitter" href="#"><i class="fab fa-twitter"></i> Twitter'da
								Paylaş</a>
...
<script>
	...
	export default {
		...
		created() {
			this.isLoading = true;
			this.$store.dispatch("posts/getUserCoupon", {username: this.userName, page: this.page}).then(res => {
